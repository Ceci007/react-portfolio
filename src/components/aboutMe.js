          ...
          <div class="sobre-mi__card">
            ...
            <div class="sobre-mi__boxes">
                <div class="sobre-mi__box">
                    <p>
                      Regarding the academy, I completed two years of Mechatronics 
                      Engineering degree at the National University of Asunción (FIUNA) 
                      until I realized that my true passion lay in frontend development.
                    </p>
                </div>
                <div class="sobre-mi__box">
                    <p>
                    ...
                    <p>
                      I also spent about 8 months on the Microverse Fulltime Program (from start to finish).
                    </p>
                </div>
            </div>
